...
#        "4.18.0-25-generic",  # release
        "5.15.0-75-generic",  # release
#        "#26~18.04.1-Ubuntu SMP Thu Jun 27 07:28:31 UTC 2019",
        "#82~20.04.1-Ubuntu SMP Thu Jun 27 07:28:31 UTC 2023",
#        "armv7l",
        "x86_64",
#        "(none)",
        "(none)",
...
def sys_set_thread_area(k, p):
    ...
    p.gdt.set_entry(0xC, userdesc.base_address, 0xFFFF, 0xFF2)

    tdata = k.z.main_module.Tls

    print("userdesc.base_address",  hex(userdesc.base_address), "len(tdata))", len(tdata))
    print("userdesc.limit",         hex(userdesc.limit))
    print("userdesc.seg_32bit",     hex(userdesc.seg_32bit))
    print("userdesc.contents",      hex(userdesc.contents))
    print("userdesc.read_exec_only",      hex(userdesc.read_exec_only))
    print("userdesc.limit_in_pages",      hex(userdesc.limit_in_pages))
    print("userdesc.seg_not_present",      hex(userdesc.seg_not_present))
    print("userdesc.useable",      hex(userdesc.useable))

    hexdump(tdata)

    print(type(k.z.main_module))
